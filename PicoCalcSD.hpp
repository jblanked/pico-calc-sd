...
public:
    ...
    File getFileAtIndex(const char *directoryPath, int targetIndex);
    int getFileCount(const char *directoryPath);
    File getFileOrDirectoryAtIndex(const char *directoryPath, int targetIndex);
